...
/******/ 	__webpack_require__.p = "/public/workfiles";
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = _react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.IndexRoute, { component: _map_page2.default })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _map_legend = __webpack_require__(260);

	var _map_legend2 = _interopRequireDefault(_map_legend);
	...
	function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } /* eslint esnext: true */
	...
	var MapPage = function (_Component) {
	  ...
	  function MapPage() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(MapPage).apply(this, arguments));
	  }

	  _createClass(MapPage, [{
	    key: 'render',
	    value: function render() {
	      var _props$map$position = this.props.map.position;
	      var lat = _props$map$position.lat;
	      var lng = _props$map$position.lng;
	      ...
	      return _react2.default.createElement(
	        'div',
	        null,
	        _react2.default.createElement(_search2.default, { onSubmit: _index3.searchLocation }),
	        _react2.default.createElement(_map_legend2.default, null),
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ fetchLandings: _index3.fetchLandings, search: _index3.searchLocation }, dispatch);
	}
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    { onSubmit: function onSubmit(event) {
	                            return _this2.onSubmit(event.target.value);
	                        } },
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SEARCH_LOCATION = exports.REMOVE_FILTER = exports.ADD_FILTER = undefined;
	exports.fetchLandings = fetchLandings;
	exports.searchLocaction = searchLocaction;
	...
	var GMAP_URL = 'gmapsapiroot';

	function fetchLandings() {
	  var request = _axios2.default.get(ROOT_URL + '/landings');
	...
	function searchLocaction(search) {
	  var request = _axios2.default.get(GMAP_URL + '/' + search);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _map_reducer = __webpack_require__(282);

	var _map_reducer2 = _interopRequireDefault(_map_reducer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var rootReducer = (0, _redux.combineReducers)({
	  map: _map_reducer2.default
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  ...
	  switch (action.type) {
	    case _index.ADD_FILTER:
	      return _extends({}, state, {
	        filters: [].concat(_toConsumableArray(state.filters), [action.payload])
	      });
	    case _index.REMOVE_FILTER:
	      return _extends({}, state, {
	        filters: [state.filters.filter(function (filter) {
	          return action.payload.type !== filter.type;
	        })]
	      });
	  }
	  return state;
	...
	var _reselect = __webpack_require__(283);

	function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

	var INITIAL_STATE = { filters: [{}], position: { lat: 32.7765, lng: -79.9311 } };
